class LevelOne extends Phaser.Scene {
    ...
    create() {
        ...
        this.map = this.add.tilemap("platformer-level-2", 18, 18, 120, 20);
        this.coincount = 0
        ...
        this.base_distance = Math.abs(my.sprite.player.x-my.sprite.dashLocation.x)
       ...
       this.carryLayer.setScale(2.0);
        ...
        this.tutorial_text_1 = this.add.text(240, 190, "Welcome to Q dash! Us the arrow keys\nto move and jump", { 
            fontFamily: 'Arial', 
            fontSize: '16px', 
            color: 'black' 
        });

        this.tutorial_text_2 = this.add.text(940, 190, "When airborne, press 'Q' to dash\nYou'll always end up at the reticle\n ahead of you", { 
            fontFamily: 'Arial', 
            fontSize: '16px', 
            color: 'black' 
        });

        this.tutorial_text_3 = this.add.text(940, 290, "Pick up coins by running into them", { 
            fontFamily: 'Arial', 
            fontSize: '16px', 
            color: 'black' 
        });

        this.tutorial_text_4 = this.add.text(1290, 190, "Momentum is built up while moving forward\nBe mindful of trying to stop suddenly\n", { 
            fontFamily: 'Arial', 
            fontSize: '16px', 
            color: 'black' 
        });

        this.tutorial_text_5 = this.add.text(2490, 190, "To exit the level, enter the door\nBe aware that dashing does have a cooldown", { 
            fontFamily: 'Arial', 
            fontSize: '16px', 
            color: 'black' 
        });
